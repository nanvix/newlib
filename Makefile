...
target_alias=i686-nanvix
target_vendor=pc
target_os=nanvix
target=i686-pc-nanvix

program_transform_name = s&^&i686-nanvix-&

prefix = /home/runner/nanvix
exec_prefix = ${prefix}
...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --target=i686-nanvix --prefix=/home/runner/nanvix --disable-multilib

tooldir = ${exec_prefix}/i686-nanvix
build_tooldir = ${exec_prefix}/i686-nanvix
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--prefix=/home/runner/nanvix' '--disable-multilib' --program-transform-name='s&^&i686-nanvix-&' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-system-zlib --with-newlib '--prefix=/home/runner/nanvix' '--disable-multilib' --program-transform-name='s&^&i686-nanvix-&' --disable-option-checking
...
TARGET_SUBDIR = i686-nanvix
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --with-newlib --with-cross-host=x86_64-pc-linux-gnu   '--prefix=/home/runner/nanvix' '--disable-multilib' --program-transform-name='s&^&i686-nanvix-&' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
AR_FOR_TARGET=i686-nanvix-ar
AS_FOR_TARGET=i686-nanvix-as
CC_FOR_TARGET=$(STAGE_CC_WRAPPER) i686-nanvix-gcc

# If GCC_FOR_TARGET is not overriden on the command line, then this
# variable is passed down to the gcc Makefile, where it is used to
# build libgcc2.a.  We define it here so that it can itself be
# overridden on the command line.
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) i686-nanvix-gcc
CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) i686-nanvix-c++
RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) i686-nanvix-c++
GCJ_FOR_TARGET=$(STAGE_CC_WRAPPER) i686-nanvix-gcj
GFORTRAN_FOR_TARGET=$(STAGE_CC_WRAPPER) i686-nanvix-gfortran
GOC_FOR_TARGET=$(STAGE_CC_WRAPPER) i686-nanvix-gccgo
DLLTOOL_FOR_TARGET=i686-nanvix-dlltool
LD_FOR_TARGET=i686-nanvix-ld

LIPO_FOR_TARGET=i686-nanvix-lipo
NM_FOR_TARGET=i686-nanvix-nm
OBJDUMP_FOR_TARGET=i686-nanvix-objdump
OBJCOPY_FOR_TARGET=i686-nanvix-objcopy
RANLIB_FOR_TARGET=i686-nanvix-ranlib
READELF_FOR_TARGET=i686-nanvix-readelf
STRIP_FOR_TARGET=i686-nanvix-strip
WINDRES_FOR_TARGET=i686-nanvix-windres
WINDMC_FOR_TARGET=i686-nanvix-windmc
...
FLAGS_FOR_TARGET =  -B$$r/$(TARGET_SUBDIR)/newlib/ -isystem $$r/$(TARGET_SUBDIR)/newlib/targ-include -isystem $$s/newlib/libc/include -B$$r/$(TARGET_SUBDIR)/libgloss/i386 -L$$r/$(TARGET_SUBDIR)/libgloss/libnosys -L$$s/libgloss/i386
