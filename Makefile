...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --target=i686-nanvix --prefix=/opt/nanvix --disable-multilib
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--prefix=/opt/nanvix' '--disable-multilib' --program-transform-name='s&^&i686-nanvix-&' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-system-zlib --with-newlib '--prefix=/opt/nanvix' '--disable-multilib' --program-transform-name='s&^&i686-nanvix-&' --disable-option-checking
...
TARGET_CONFIGARGS = --cache-file=./config.cache --with-newlib --with-cross-host=x86_64-pc-linux-gnu   '--prefix=/opt/nanvix' '--disable-multilib' --program-transform-name='s&^&i686-nanvix-&' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
